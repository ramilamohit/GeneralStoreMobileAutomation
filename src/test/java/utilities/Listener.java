...
{
	protected static Logger Listenerlog = LogManager.getLogger();
	...
	public void onTestFailure(ITestResult result) {
		Listenerlog.info("............."+result.getMethod().getMethodName()+".......test execution completed with failure........");
	...
	public void onTestSkipped(ITestResult result) {
		Listenerlog.info("............."+result.getMethod().getMethodName()+".......test execution skipped........");
		extentReport.logTestSkpied(result.getMethod().getMethodName()+"test execution skipped");
	}

	@Override
	public void onTestFailedWithTimeout(ITestResult result) {
		Listenerlog.info("............."+result.getMethod().getMethodName()+".......test execution failed with timeout........");
	...
	public void onFinish(ITestContext context) {
		Listenerlog.info("............."+context.getName()+".....has finised................");
